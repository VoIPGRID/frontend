...
export function helpers(app) {
     ...
     * // [[1,2,3],[4,5,6],[7,8,9],[0]]
     */
    _helpers.chunk = function(items, chunkSize) {
        let R = []
     ...
     * // {page: "1"}
     */
    _helpers.parseSearch = function(query) {
        let e, k, v
        let re = /([^&=]+)=?([^&]*)/g
     ...
     * // page=1
     */
    _helpers.stringifySearch = function(params) {
     ...
     */
    _helpers.lastRoute = function(defaultRoute, params = {}) {
     ...
     */
    _helpers.injectScript = function(src, cb) {
