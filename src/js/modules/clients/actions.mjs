export function actions(app, _module) {
    ...
    */
    _actions.deleteClient = async function(client) {
    ...
    */
    _actions.readClient = async function(clientId, formEndpoints = true) {
        let context = {}
        let promises = []
     ...
     */
    _actions.readClients = async function({page}) {
    ...
    */
    _actions.upsertClient = function(client) {
