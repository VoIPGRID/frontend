export function actions(app, _module) {
    /**
    ...
    */
    _actions.deleteUser = async function(user) {
    ...
    */
    _actions.login = function(root, credentials) {
    ...
    */
    _actions.readUser = async function(clientId, partnerId, userId) {
        let context = {}
        let promises = []
        let baseUrl
    ...
    */
    _actions.readUserDestinations = async function(clientId, userId) {
    ...
    */
    _actions.readUsers = async function({page, path}) {
     ...
     */
    _actions.setLanguage = async function(e) {
    ...
    */
    _actions.upsertUser = function(user, validator) {
        let backRoute, url
        const clientId = app.router.currentRoute.params.client_id
        const partnerId = app.router.currentRoute.params.partner_id
