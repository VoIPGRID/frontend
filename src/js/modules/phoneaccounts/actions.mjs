export function actions(app, _module) {
    ...
    */
    _actions.deletePhoneaccount = async function(client) {
    ...
    */
    _actions.readPhoneaccount = async function(clientId, phoneaccountId, formEndpoints = true) {
        let context = {}
        let promises = []
    ...
    */
    _actions.readPhoneaccounts = async function(clientId, page) {
    ...
    */
    _actions.upsertPhoneaccount = function(clientId, phoneaccount) {
