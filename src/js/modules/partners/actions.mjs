export function actions(app, _module) {
    ...
    */
    _actions.deletePartner = function(partner) {
    ...
    */
    _actions.readPartner = async function(partnerId, formEndpoints = true) {
        let context = {}
        let promises = []
    ...
    */
    _actions.readPartners = async function({page}) {
    ...
    */
    _actions.upsertPartner = function(partner) {
