                    ...
                    <section className="section">
                        <div>
                            <Switch>
                                ...
                                <PrivateRoute exact path="/partners/:partnerId/edit" component={AsyncPartnerForm} />
                                <PrivateRoute staticName={true} exact path="/partners/:partnerId/clients/" component={AsyncClientList} />
                                <PrivateRoute exact path="/partners" component={AsyncPartnerList} />
                                <PrivateRoute exact path="/clients" component={AsyncClientList} />
                                <PrivateRoute exact path="/user/personal_settings" component={AsyncUserProfileForm} />
                            </Switch>
                        </div>
                    </section>
                </div>
